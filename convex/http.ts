...
http.route({
  ...
  handler: httpAction(async (ctx, request) => {
    const webhookSecrete = process.env.CLERK_WEBHOOK_SECRET;
    ...
    const wh = new Webhook(webhookSecrete);
    ...
    try {
      ...
      console.log("Webhook verified, event type:", evt.type); // Add this
    } catch (error) {
    ...
    if (eventType === "user.created") {
      ...
      try {
        ...
        console.log("User created successfully"); // Add thisc
      } catch (error) {
